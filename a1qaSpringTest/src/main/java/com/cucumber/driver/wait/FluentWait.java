...
import com.cucumber.driver.exception.TimeoutException;
...
public class FluentWait<T> implements Wait<T> {
	...
	private final CustomSleeper sleeper;
	...
	public FluentWait(T input) {
		this(input, new Clock(), CustomSleeper.SYSTEM_SLEEPER);
	}
	 ...
	 */
	public FluentWait(T input, Clock clock, CustomSleeper sleeper) {
